...
public class AppMsg {
	 ...
	 * style.
	 */
	public static final Style STYLE_ALERT = new Style(LENGTH_LONG, 0xFFCC0000);

	/**
	 * Show the text notification for a short period of time with a positive
	 * style.
	 */
	public static final Style STYLE_CONFIRM = new Style(LENGTH_SHORT, 0xFFFF8800);

	/**
	 * Show the text notification for a short period of time with a neutral
	 * style.
	 */
	public static final Style STYLE_INFO = new Style(LENGTH_SHORT, 0xFF669900);
